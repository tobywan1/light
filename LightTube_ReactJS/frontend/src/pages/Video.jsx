...
const Video = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const videoResp = await axios.get(`http://localhost:3000/api/video/find/${path}`)
        const channelResp = await axios.get(`http://localhost:3000/api/user/find/${videoResp.data.userId}`)
  ...
  const handleLike = async()=>{
    await axios.put(`http://localhost:3000/api/user/likes/${currentVideo._id}`,{headers: {
  ...
  const handleDislike = async()=>{
    await axios.put(`http://localhost:3000/api/user/dislikes/${currentVideo._id}`,{headers: {
      Authorization: 'Bearer'
    }},{withCredentials : true})
  ...
  const handleSubscribe = async()=>{
    ...
    await axios.put(`http://localhost:3000/api/user/unsub/${channel._id}`,{headers: {Authorization: 'Bearer' }},{withCredentials : true}) :
    await axios.put(`http://localhost:3000/api/user/sub/${channel._id}`,{headers: { Authorization: 'Bearer' }},{withCredentials : true})
